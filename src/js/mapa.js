...
if (navigator.geolocation) {
  ...
  navigator.geolocation.getCurrentPosition(function (position) {
    ...
    function moveMapToBerlin(map) {
      ...
      map.setZoom(14);
      var miUbicacion = new H.map.Marker({ lat: pos.position.latitude, lng: pos.position.longitude });
      map.addObject(miUbicacion);
    ...
    function logEventServipag(e) {
      ...
      var modal = document.getElementById('myModalServipag');
      modal.style.display = "block";
      var direccion = document.getElementById('direccionServipag');
      var span = document.getElementById('spaneServipag');
      direccion.innerHTML = data.vicinity;
...
function ruta(e) {
  ...
  if (navigator.geolocation) {
    ...
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      let lat = pos.position.latitude.toString();
      let lng = pos.position.longitude.toString();
      let latpoint1 = e.position[0].toString();
      let lngpoint1 = e.position[1].toString();
      console.log(lat, lng)
