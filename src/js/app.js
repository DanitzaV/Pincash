...
<div class="row">
    <div class="col-12 text-center">
        ...
        <div class="modal fade" id="signUp" tabindex="-1" role="dialog" aria-labelledby="signUpLabel" aria-hidden="true">
            <div class="modal-dialog entrada" role="document">
                  ...
                  <span aria-hidden="true" id="closingX1">&times;</span>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <small class="form-text text-muted" id="conditions">Registrándote, automáticamente aceptas los <a onclick="termsAndConditions()" data-dismiss="modal">Términos y condiciones.</a></small>
                        </form>
                    </div>
...
<div class="container-fluid transition">
    ...
    <div class="row footer text-center fixed-bottom">
        <div class="col-5 p-0">  
            <i class="fas fa-location-arrow"></i>
            <h6 class="cajero-texto">Cajero cercano</h6>  
        </div>
        <div class="col-2 p-0">
            <button type="button" class="btnFooter rounded-circle shadow p-3 bg-white rounded border border-white"><i class="fas fa-sync-alt"></i></button>
        </div>
        <div class="col-5 p-0">   
        <button type="button" class="btn reportBtn" data-toggle="modal" data-target="#myModal"><i class="fas fa-file-invoice showForm "></i></button>
            <h6 class="reportar-texto ">Reportar</h6>
        </div>
    </div>    
</div>
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Cajero</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="container-fluid transition">
    <div class="row cash">
        ...
        <button type="button" class="btn btn-back mb-5" onclick="displayLogin()">Volver</button>
        </div>
    </div>
</div>
`;
